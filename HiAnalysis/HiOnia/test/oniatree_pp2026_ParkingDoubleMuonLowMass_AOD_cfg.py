...
#----------------------------------------------------------------------------
# OniaTree on 2026 pp data, ParkingDoubleMuonLowMass AOD (PromptReco)
# Goal: J/psi reconstruction with NO dimuon pT cut (pT >= 0)
#----------------------------------------------------------------------------

HLTProcess     = "HLT"
isMC           = False
muonSelection  = "GlbOrTrk"  # loose: tracker OR global muons, needed for pT(J/psi) -> 0
applyCuts      = False       # no kinematic acceptance cuts at HiAnalysis level
OnlySoftMuons  = False
doTrimuons     = False
doDimuonTrk    = False
...
OneMatchedHLTMu = -1
keepExtraColl  = False
miniAOD        = False       # input is AOD: reco::Muon "muons" used directly
pdgId          = 443
useMomFormat   = "vector"    # flat std::vector<float> branches
...
options.inputFiles = [
    'file:/eos/cms/store/data/Run2026C/ParkingDoubleMuonLowMass0/AOD/PromptReco-v1/000/402/536/00000/9fa9dfcc-4c0a-41f9-b582-397bc788a152.root',
]
options.outputFile = 'Oniatree_pp2026C_ParkingDoubleMuonLowMass0_AOD.root'
options.maxEvents = -1
options.parseArguments()

# HLT paths actually present in the Run2026C menu (checked on file).
# Trailing "_v" => version-independent matching in HiOnia.
triggerList = {
...
# 2026 prompt-data conditions (autoCond run3_data_prompt -> 160X_dataRun3_Prompt_frozen260223_v1)
...
# Single-muon selection: NO pT cut, just quality/geometry
